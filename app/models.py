...
class Relation(db.Model):
    ...
    relation_type = db.Column(db.String(80), nullable=False)
    direction_mode = db.Column(db.String(20), nullable=False, default="one_way")
    inverse_relation_type = db.Column(db.String(80), nullable=True)
